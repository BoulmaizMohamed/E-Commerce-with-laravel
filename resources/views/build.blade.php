...
<input type="radio" name="mother" value="ASUS Prime Z590-P LGA 1200" onclick="myFunction()">ASUS Prime Z590-P LGA 1200 ------100<br>
<input type="radio" name="mother" value="GIGABYTE B450M DS3H V2" onclick="myFunction1()">GIGABYTE B450M DS3H V2 ------250<br>
<input type="radio" name="mother" value="ROG Strix Z590-E Gaming" onclick="myFunction2()">ROG Strix Z590-E Gaming------ 600</br>
